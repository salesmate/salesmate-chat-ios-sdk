...
- Fixed wrong `kRapidopsQSKeyLocationIP` key in location info requests
...
- Added `Rapidops_EXCLUDE_IDFA` pre-processor flag to exclude IDFA references
...
- Other various improvements
  ...
  - Deleted unnecessary `RPDMessaging` definition
...
- Improved Rapidops payload check in notification dictionary
...
- Refactored push notifications  
  ...
  - Renamed feature name from `RPDMessaging` to `RPDPushNotifications`
...
- Other various improvements
  ...
  - Renamed constant kRapidopsStarRatingButtonSize to prevent compile time conflicts
  ...
  - Prevented Rapidops internal view controllers from being tracked by AutoViewTracking
