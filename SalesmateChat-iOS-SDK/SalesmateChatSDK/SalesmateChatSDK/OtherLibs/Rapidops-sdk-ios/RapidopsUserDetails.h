...
/**
 * A placeholder type specifier which accepts only @c NSString or @c NSNull for @c RapidopsUserDetails default properties.
 */
@protocol RapidopsUserDetailsNullableString <NSObject>
@end
@interface NSString (NSStringWithRapidopsUserDetailsNullableString) <RapidopsUserDetailsNullableString>
@end
@interface NSNull (NSNullWithRapidopsUserDetailsNullableString) <RapidopsUserDetailsNullableString>
@end


/**
 * A placeholder type specifier which accepts only @c NSDictionary or @c NSNull for @c RapidopsUserDetails default properties.
 */
@protocol RapidopsUserDetailsNullableDictionary <NSObject>
@end
@interface NSDictionary (NSDictionaryWithRapidopsUserDetailsNullableDictionary) <RapidopsUserDetailsNullableDictionary>
@end
@interface NSNull (NSNullWithRapidopsUserDetailsNullableDictionary) <RapidopsUserDetailsNullableDictionary>
@end


/**
 * A placeholder type specifier which accepts only @c NSNumber or @c NSNull for @c RapidopsUserDetails default properties.
 */
@protocol RapidopsUserDetailsNullableNumber <NSObject>
@end
@interface NSNumber (NSNumberWithRapidopsUserDetailsNullableNumber) <RapidopsUserDetailsNullableNumber>
@end
@interface NSNull (NSNullWithRapidopsUserDetailsNullableNumber) <RapidopsUserDetailsNullableNumber>
@end

extern NSString* const kRapidopsLocalPicturePath;

@interface RapidopsUserDetails : NSObject
 ...
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableString> _Nullable name;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableString> _Nullable username;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableString> _Nullable email;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableString> _Nullable organization;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableString> _Nullable phone;
 ...
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableString> _Nullable gender;

/**
 * Default @c pictureURL property for user's profile photo in User Profiles.
 * @discussion It can be set to an @c NSString, or @c NSNull for clearing it on server.
 * It will be sent to server when @c recordUserDetails method is called.
 * @discussion It should be a publiRPD accessible URL string to user's profile photo, so server can download it.
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableString> _Nullable pictureURL;
 ...
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableString> _Nullable pictureLocalPath;
 ...
 * It will be sent to server when @c recordUserDetails method is called.
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableNumber> _Nullable birthYear;
 ...
 */
@property (nonatomic, copy) id<RapidopsUserDetailsNullableDictionary> _Nullable custom;

/**
 * Returns @c RapidopsUserDetails singleton to be used throughout the app.
 * @return The shared @c RapidopsUserDetails object
 * @discussion @c Rapidops.user convenience accessor can also be used.
 */
